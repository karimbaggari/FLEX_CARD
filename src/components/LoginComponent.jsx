            ...
            <div className="max-w-screen-2xl px-4 md:px-8 -mt-12 mx-auto">
                ...
                <form className="max-w-lg border rounded-lg mx-auto">
                    <div className="flex flex-col gap-4 p-4 md:p-8">
                        <div>
                            <label for="email" className="inline-block flex flex-start text-gray-800 text-sm sm:text-base mb-2" style={{ "fontWeight": "bold" }}>Email</label>
                            <input name="email" className="w-full bg-gray-50 text-gray-800 border focus:ring ring-indigo-300 rounded outline-none transition duration-100 px-3 py-2" placeholder='example@name.com' />
                        </div>

                        <div>
                            <label for="password" className="inline-block text-gray-800 flex flex-start text-sm sm:text-base mb-2" style={{ "fontWeight": "bold" }} >Password</label>
